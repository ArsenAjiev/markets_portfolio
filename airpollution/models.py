...
class PollutantEntry(models.Model):
    """Pollution_entry model for airpollution app"""
    pollutant = models.ForeignKey(Pollutant, on_delete=models.CASCADE, related_name='entries_pollutant')
    country = models.ForeignKey(Country, on_delete=models.CASCADE, related_name='entries_country')
