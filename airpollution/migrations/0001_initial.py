# Generated by Django 4.0.4 on 2022-04-26 08:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pollution_level', models.ImageField(upload_to='')),
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entries_country', to='airpollution.country')),
                ('pollutant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entries_pollutant', to='airpollution.pollutant')),
            ],
            options={
